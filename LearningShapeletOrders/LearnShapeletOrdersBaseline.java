 ...
 */
public class LearnShapeletOrdersBaseline {
    ...
    public void Initialize() {
        ...
        W = new double[C][R][K + H];
        biasW = new double[C];
        //delta = new double[C];
        //u = new double[C];
        //for (int c = 0; c<C;c++)

        GradHistW = new double[C][R][K + H];
                ...
                for (int c = 0; c < C; c++) {
                    ...
                    for (int r = 0; r < R; r++) { //here starts for each scale
                        ...
                        for (int k = 0; k < K; k++) {
                            ...
                            gradW = dLdY * M[i][r][k] + regWConst * W[c][r][k];

                            // add gradient square to the history
                            GradHistW[c][r][k] += gradW * gradW;

                            // update the weights
                            W[c][r][k] -= (eta / (Math.sqrt(GradHistW[c][r][k]) + eps)) * gradW;
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        for (String name : datasets) {
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LearnShapeletOrdersBaseline lso = new LearnShapeletOrdersBaseline();
