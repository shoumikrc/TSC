...
public class LOSKmeansInitBinaryClassification {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        System.out.println("LSO  without gamma for Binary Classification Kmeans Init");
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LOS_Results_Kmeans_init.txt";
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LOSKmeansInitBinaryClassification lso = new LOSKmeansInitBinaryClassification();
                //lso.runPython();
