...
public class LearningShapeletOrdersBinaryClassificationMatrixProfileInit {
    ...
    public static void main(String [] args) throws FileNotFoundException, IOException{
        ...
        for(String name : datasets){
            ...
            for(long seed = 0;seed<numofSeeds;seed++ ){
                ...
                //Java class object
                LearningShapeletOrdersBinaryClassificationMatrixProfileInit lso = new LearningShapeletOrdersBinaryClassificationMatrixProfileInit(); 
                //lso.runPython();
