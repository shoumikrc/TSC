 ...
 */
public class LOSGammaBinaryClassification {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LOS_Gamma_Results_random_init.txt";
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LOSGammaBinaryClassification lso = new LOSGammaBinaryClassification();
                //lso.runPython();
