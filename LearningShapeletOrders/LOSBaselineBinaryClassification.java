...
public class LOSBaselineBinaryClassification {
...
//                    delta[c] = calculateSigmoid(delta[c]);
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LTS_Orders_Results.txt";
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LOSBaselineBinaryClassification lso = new LOSBaselineBinaryClassification();
            ...
            System.out.println("Number of Shapelets: " + numOfShapelets);
