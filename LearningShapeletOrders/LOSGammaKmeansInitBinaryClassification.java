...
public class LOSGammaKmeansInitBinaryClassification {
    ...
    public void PrintGammaParameters(String outputfile) throws FileNotFoundException {
        ...
        //for (int c = 0; c < C; c++) {
        System.out.println("Gamma parameters: " + String.format("%.2f",delta) + " " + (String.format("%.2f",1 - delta)));
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        System.out.println("LSO with gamma parameters for Binary Classification Kmeans Init");
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LOS_Gamma_Results_kmeans_init.txt";
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LOSGammaKmeansInitBinaryClassification lso = new LOSGammaKmeansInitBinaryClassification();
                //lso.runPython();
