...
public class LOSGammaKmeansInitMultiClassification {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        String maindirectory = homedirectory + category + "/multi/";
        ...
        for (String name : datasets) {
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LOSGammaKmeansInitMultiClassification lso = new LOSGammaKmeansInitMultiClassification();
